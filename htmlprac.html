...
<div style="border: 2px ;padding:20px;background-color:#6a5acd;font-size: 20px">
...
<div style="border:4px solid orange;margin: 10px; padding: 50px;">
	<h3>this is iframe</h3>
	<iframe src="https://en.wikipedia.org/wiki/Main_Page" height="300px" width="600px"></iframe>
	<iframe src="https://getemoji.com/" height="200px" width="200px" style="margin:50px"></iframe>
	<iframe width="250" height="315" src="https://www.youtube.com/embed/gpjv--hxUQM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>" 
</div>
<div style="background-color: #d95bf0;padding: 20px">
	<p style="font-size:48px ;margin:20px" title="these are emojis">
	&#128512; &#128516; &#128525; &#128151;	&#128514;
    </p>
</div>
<div style="border: 2px solid black;background-image: url('new.webp');padding: 20px">
	<h2>To give tab in html use</h2>
	<pre style="padding: 10px;font-size: 20px">1]using   pre tab
	  we can have the paragraph   shown as ,
	   it is written. </pre>
    ...
    <details>
    	<summary>Click Here This is summary tab</summary>
    		<p style="background-image: url('back.jpg');">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
    		tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
    		quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
    		consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
    		cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non
